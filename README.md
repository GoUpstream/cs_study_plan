...
### 2.0.0 UCB CS courses：

1. COMPUTER SCIENCE 61A — THE STRUCTURE AND INTERPRETATION OF COMPUTER PROGRAMS (4 UNITS)

2. COMPUTER SCIENCE 61B — DATA STRUCTURES (4 UNITS)

3. COMPUTER SCIENCE 61C — MACHINE STRUCTURES (4 UNITS)

4. COMPUTER SCIENCE 70 — DISCRETE MATHEMATICS AND PROBABILITY THEORY (4 UNITS)

5. COMPUTER SCIENCE 161 — COMPUTER SECURITY (4 UNITS)

6. COMPUTER SCIENCE 162 — OPERATING SYSTEMS AND SYSTEM PROGRAMMING (4 UNITS)

7. COMPUTER SCIENCE 164 — PROGRAMMING LANGUAGES AND COMPILERS (4 UNITS)

8. COMPUTER SCIENCE 168 — INTRODUCTION TO THE INTERNET: ARCHITECTURE AND PROTOCOLS (4 UNITS)

9. COMPUTER SCIENCE 169 — SOFTWARE ENGINEERING (4 UNITS)

10. COMPUTER SCIENCE 170 — EFFICIENT ALGORITHMS AND INTRACTABLE PROBLEMS (4 UNITS)

11. COMPUTER SCIENCE 186 — INTRODUCTION TO DATABASE SYSTEMS (4 UNITS)
